...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.example.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8080/SaopWebProject/services/HelloWorld";
    ...
    public com.example.HelloWorld getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public com.example.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.example.HelloWorldSoapBindingStub _stub = new com.example.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.example.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.example.HelloWorldSoapBindingStub _stub = new com.example.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://example.com", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://example.com", "HelloWorld"));
        }
